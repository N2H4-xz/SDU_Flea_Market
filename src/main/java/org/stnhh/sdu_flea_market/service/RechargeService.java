...
public interface RechargeService {
    Recharge createRecharge(Long userId, RechargeRequest request);
    PageResponse<RechargeResponse> getRechargeHistory(Long userId, Integer page, Integer limit, String status);
}
