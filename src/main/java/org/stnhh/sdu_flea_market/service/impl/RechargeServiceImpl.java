...
public class RechargeServiceImpl implements RechargeService {
    ...
    public Recharge createRecharge(Long userId, RechargeRequest request) {
        ...
        recharge.setPaymentMethod(request.getPayment_method());
        // In a real scenario, this would be generated by a payment gateway
        recharge.setPaymentUrl("https://payment.example.com/pay/" + System.currentTimeMillis());
    ...
    public PageResponse<RechargeResponse> getRechargeHistory(Long userId, Integer page, Integer limit, String status) {
        ...
        List<RechargeResponse> items = pageResult.getRecords().stream().map(recharge -> {
            ...
            response.setPayment_url(recharge.getPaymentUrl());
            response.setCreated_at(recharge.getCreatedAt());
            response.setCompleted_at(recharge.getCompletedAt());
            return response;
