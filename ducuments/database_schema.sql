...
CREATE TABLE IF NOT EXISTS `products` (
  `product_id` CHAR(36) NOT NULL COMMENT '商品ID (UUID)',
  `seller_id` CHAR(36) NOT NULL COMMENT '卖家ID (外键)',
...
CREATE TABLE IF NOT EXISTS `product_images` (
  `image_id` CHAR(36) NOT NULL COMMENT '图片ID (UUID)',
  `product_id` CHAR(36) NOT NULL COMMENT '商品ID (外键)',
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `product_id` CHAR(36) NOT NULL COMMENT '商品ID (外键)',
  `buyer_id` CHAR(36) NOT NULL COMMENT '买家ID (外键)',
  `seller_id` CHAR(36) NOT NULL COMMENT '卖家ID (外键)',
...
CREATE TABLE IF NOT EXISTS `comments` (
  `comment_id` CHAR(36) NOT NULL COMMENT '留言ID (UUID)',
  `product_id` CHAR(36) NOT NULL COMMENT '商品ID (外键)',
  `author_id` CHAR(36) NOT NULL COMMENT '作者ID (外键)',
...
CREATE TABLE IF NOT EXISTS `favorites` (
  `favorite_id` CHAR(36) NOT NULL COMMENT '收藏ID (UUID)',
...
CREATE TABLE IF NOT EXISTS `messages` (
  ...
  `sender_id` CHAR(36) NOT NULL COMMENT '发送者ID (外键)',
  `recipient_id` CHAR(36) NOT NULL COMMENT '接收者ID (外键)',
...
CREATE TABLE IF NOT EXISTS `recharges` (
  `recharge_id` CHAR(36) NOT NULL COMMENT '充值ID (UUID)',
  `user_id` CHAR(36) NOT NULL COMMENT '用户ID (外键)',
...
CREATE TABLE IF NOT EXISTS `user_wallets` (
  `wallet_id` CHAR(36) NOT NULL COMMENT '钱包ID (UUID)',
  `user_id` CHAR(36) NOT NULL UNIQUE COMMENT '用户ID (外键)',
